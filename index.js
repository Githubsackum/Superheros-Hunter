  ...
  .then( (data) => {
    ...
    let item = `<div class="card item h-50 m-4 hero" style="width: 13rem;">
            ...
            <div class="card-body d-flex flex-row justify-content-around">
              ...
              <div class="fav-btn" >
                <img class="favImg" id="${data.id}"  src="images/unFav.png" alt="Unfav" >
              </div>
            </div>
          </div>`
...
async function showFavExistence(f){
  ...
  if(fav.includes(id)){
    ...
    //update fav icon
    child.setAttribute('src','images/fav.png')
    ...
    .then( (data) => {
      if(data.response === 'success'){
        ...
        for( hero  of heroes ){
          ...
          a.setAttribute('href',`showDetails.html?id=${hero.id}`)
